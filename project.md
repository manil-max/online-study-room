...
> **Deploy gerçeği (2026-07-23):** Local/staging migration head `0068`, production head `0065`tir. `0066–0068` yalnız staging'e uygulanmış ve production'a uygulanmamıştır. Production migration history zinciri hâlâ normal CLI terfisi için uzlaştırılmış değildir; yeni stable/production mutasyonu HOLD'dur. Yeni migration mevcut en yüksek yerel numaradan (`0068`) devam eder; herhangi bir remote'a uygulanmış dosya geriye dönük değiştirilmez.
