...
List<AchievementDictEntry> kAchievementDictV3([AppLocalizations? l10n]) {
  ...
  return [
    e(
      ...
      [
        // WP-255 yeniden fiyatlandırma (sunucu: 0065_reprice_core_economy.sql).
        (1, 50, 'hours', 1500),
        (2, 200, 'hours', 5000),
        (3, 500, 'hours', 15000),
        (4, 1000, 'hours', 30000),
    ...
    e(
      ...
      [
        // WP-255 yeniden fiyatlandırma.
        (1, 7, 'streak_days', 1000),
        (2, 30, 'streak_days', 2500),
        (3, 150, 'streak_days', 7500),
        (4, 365, 'streak_days', 25000),
        (5, 730, 'streak_days', 75000),
        (6, 1000, 'streak_days', 150000),
      ],
    ...
    e(
      ...
      [
        // WP-255: yalnız ilk iki kademe yeniden fiyatlandırıldı.
        (1, 5, 'locomotive_events', 250),
        (2, 15, 'locomotive_events', 750),
