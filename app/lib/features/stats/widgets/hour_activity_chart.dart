...
class HourActivityChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Widget'ın TOPLAM yüksekliği [height]'i aşmasın (§2E): tepe satırı ve eksen
    // etiketleri sabit, çubuklar kalan alanı Expanded ile doldurur. Böylece bir
    // bounded kutu (kart hücresi) içinde taşma olmaz.
    return SizedBox(
      height: height,
      child: Column(
