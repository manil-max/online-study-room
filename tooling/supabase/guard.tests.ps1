...
Assert-Equal (Get-LocalMigrationHead -RepoRoot $repoRoot) '0079' 'local migration head'
Assert-Equal ((Get-DeployContract -RepoRoot $repoRoot).local_migration_head) '0079' 'contract migration head'
