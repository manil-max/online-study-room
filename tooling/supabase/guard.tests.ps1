...
Assert-Equal $contract.staging.migration_head '0141' 'staging hedefi 0141: gunluk hedef tamamlanma aninda dondurulur (WP-828)'
...
Assert-Equal ([bool]$contract.staging.deploy_enabled) $false '0141 staging apply KOSTU (run 34854599457, post-check 0141|0141|0141) ve kapi yeniden kilitlendi'
...
Assert-Equal $contract.production.migration_head '0141' 'production hedefi 0141: gunluk hedef tamamlanma aninda dondurulur (WP-828)'
...
Assert-Equal ([bool]$contract.production.deploy_enabled) $false '0141 production apply KOSTU (run 34855466018, post-check 0141|0141|0141) ve kapi yeniden kilitlendi'
...
Assert-Equal ([bool]$contract.production.release_enabled) $true 'production release kapisi ACIK (v79/v80/v81 bu kapidan cikti, head 0138, yeni migration yok); her tag kendi taze GO dizesini ister'
