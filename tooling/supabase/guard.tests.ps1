...
Assert-Equal (Get-LocalMigrationHead -RepoRoot $repoRoot) '0081' 'local migration head'
Assert-Equal ((Get-DeployContract -RepoRoot $repoRoot).local_migration_head) '0081' 'contract migration head'
