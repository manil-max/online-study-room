...
Assert-Equal (Get-LocalMigrationHead -RepoRoot $repoRoot) '0080' 'local migration head'
Assert-Equal ((Get-DeployContract -RepoRoot $repoRoot).local_migration_head) '0080' 'contract migration head'
