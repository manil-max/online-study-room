...
Assert-Equal (Get-LocalMigrationHead -RepoRoot $repoRoot) '0078' 'local migration head'
Assert-Equal ((Get-DeployContract -RepoRoot $repoRoot).local_migration_head) '0078' 'contract migration head'
