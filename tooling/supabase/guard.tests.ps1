...
Assert-Equal ([bool]$contract.staging.deploy_enabled) $true '0144 staging apply icin kapi ACIK (sahip emri: iOS icin her seyi hazirla); pgTAP 070 ilk kez CI dry-run icinde kosar'
