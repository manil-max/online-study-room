...
Assert-Equal ([bool]$contract.staging.deploy_enabled) $true '0133 staging apply icin ACIK; apply sonrasi ayri commit ile yeniden kilitlenir'
...
Assert-Equal ([bool]$contract.production.deploy_enabled) $true '0133 production apply icin ACIK; apply sonrasi ayri commit ile yeniden kilitlenir'
