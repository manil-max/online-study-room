...
Assert-Equal (Get-LocalMigrationHead -RepoRoot $repoRoot) '0076' 'local migration head'
Assert-Equal ((Get-DeployContract -RepoRoot $repoRoot).local_migration_head) '0076' 'contract migration head'
