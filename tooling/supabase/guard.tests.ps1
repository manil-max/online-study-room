...
Assert-Equal (Get-LocalMigrationHead -RepoRoot $repoRoot) '0077' 'local migration head'
Assert-Equal ((Get-DeployContract -RepoRoot $repoRoot).local_migration_head) '0077' 'contract migration head'
