...
Assert-Equal ([bool]$contract.staging.deploy_enabled) $true '0131+0132 staging kapisi ACIK'
...
Assert-Equal ([bool]$contract.production.deploy_enabled) $true '0131+0132 production kapisi ACIK'
