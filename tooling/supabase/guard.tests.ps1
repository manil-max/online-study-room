...
Assert-Equal ([bool]$contract.staging.deploy_enabled) $true '0142 staging apply icin kapi ACIK (sahip emri: ikisini de yap); pgTAP ilk kez CI dry-run icinde kosar'
