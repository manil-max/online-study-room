...
| WP-258 | [~] Production onayı bekliyor | v43 stable (`1.0.43+43`) hazırlığı + production `0065` apply | ⚠️ **sıra: production-apply → v43 tag**; deploy sözleşmesinde production kapısı kullanıcı onayıyla AÇILDI (head 0065) |
