...
- **Son WP numarası:** **253** (WP-249 = v42 stable release hazırlığı `94947fc`; WP-250 = durdurma çift-sayımı settling modeli; WP-251 = native kuyruk idempotency; WP-252 = native pomodoro ExactAlarm **onay bekliyor**; WP-253 = UX sıralama seri rozeti + manuel çakışma koruması **kod tamam**). **Sıradaki boş numara WP-254.** (WP-221–224 geçmişte kullanılmış; kurtarma WP-225–232; WP-233/234 beta-v4202; WP-235–239 saha turu 2; WP-241/242 beta-v4204; WP-243/244 beta-v4205; WP-245–248 beta-v4206; WP-249 v42 stable; WP-250–253 sayaç düzeltme programı → `docs/WP-250-253-SAYAC-DUZELTME-PLANI.md`.)
...
### Claude Lane
- **Durum:** [~] Aktif
- **Faz/WP:** WP-250 (durdurma çift-sayımı — settling modeli) + WP-251 (native kuyruk idempotency) + WP-253 (UX: seri rozeti + manuel çakışma koruması). Öncesi: WP-245/246/247 (durdurma kök neden 3'lü fix) + WP-248 (beta-v4206 yayını).
...
| WP-253 | [x] Kod tamam | UX: sıralama satırlarındaki üye seri rozeti KALDIRILDI (ateş ikonu artık her yerde tek anlam = hedef serisi) + manuel eklemede "bugün & sayaç çalışıyor" koruması | tek WP-253 commit'i · 4 yeni test, kırmızı-yeşil ispatı yapıldı · analyze 0 issue · 661 test yeşil |
