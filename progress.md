...
| WP-868 | (hunter) Loopback'e bozuk yüzde kodlu sorgu → yanıtsız istek + yakalanmamış FormatException; artık 400 | Düzeltildi `90b5ed68` |
| WP-869 | (hunter) Tur açıkken ekrandan geri çıkınca tur 'çalışıyor'da kalıp diğer turları kilitliyordu; askıya alınır (sekme değişimi hâlâ eski davranış — İDDİA) | Düzeltildi `e7f1bef7` |
