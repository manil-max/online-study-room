...
| WP-251 | [x] Cihaz QA bekliyor | 🔴 P1: Native aralık kuyruğu — kısmi hatada başarılı kayıtlar tekrar yazılıyordu (DB'de çift oturum) + toptan silme reconcile sırasında eklenen aralığı kaybediyordu | ✅ native UUID + id-bazlı kısmi silme; repo zaten idempotent (`upsert onConflict:id`) |
