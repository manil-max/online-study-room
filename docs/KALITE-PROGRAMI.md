...
| Başarım+Görev+Grup PP (WP-208–220) | 🟡 **v3.2 geçişi sürüyor** (`docs/features/BASARIM-GOREV-GRUPPP-PLAN-2026-07.md`); `0063` ile manuel/sayaç/native süre eşitliği kanon, verified-only XP kapısı iptal |
