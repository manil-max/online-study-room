...
| Başarım & Sosyal Profil 3.0 (WP-56/57) | ✅ Tamamlandı → **iyileştirme WP-208–211 + WP-216–219** (güvenli claim rollout + verified oturum + ölü başarı fix) |
...
| Başarım+Görev+Grup PP (WP-208–219) | 🟡 **Planlandı v3** (`docs/features/BASARIM-GOREV-GRUPPP-PLAN-2026-07.md`); reward aktivasyonu WP-219 release kapısıdır |
